...
+    def _validate_coingecko_config(self):
+        if not self.coingecko_api_key:
+            raise ValueError("COINGECKO_API_KEY is required and cannot be empty/whitespace")
+
...
+
+        if self.coingecko_auth_mode == "pro" and "pro-api.coingecko.com" not in parsed.netloc:
